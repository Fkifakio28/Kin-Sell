...
function ThemeToggleDrawer({ t }: { t: (k: string) => string }) {
  const { theme, toggleTheme } = useTheme();
  return (
    <button className="hm-drawer-theme-btn" onClick={toggleTheme} aria-label={t("footer.themeAria")}>
      {theme === "dark" ? (
        <>
