...
const ruleUserNeedsBoost: AdvisorRule = (ctx) => {
  ...
  return {
    ...
    ctaTarget: "/forfaits?highlight=BOOST",
    pricing: "6$/mois",
    signals,
...
const ruleUserNeedsAuto: AdvisorRule = (ctx) => {
  ...
  return {
    ...
    ctaTarget: "/forfaits?highlight=AUTO",
    pricing: "12$/mois",
    signals,
...
const ruleUserNeedsProVendor: AdvisorRule = (ctx) => {
  ...
  return {
    ...
    ctaTarget: "/forfaits?highlight=PRO_VENDOR",
    pricing: "20$/mois",
    signals,
...
const ruleBusinessNeedsBusiness: AdvisorRule = (ctx) => {
  ...
  return {
    ...
    ctaTarget: "/forfaits?highlight=BUSINESS",
    pricing: "30$/mois",
    signals,
...
const ruleBusinessNeedsScale: AdvisorRule = (ctx) => {
  ...
  return {
    ...
    ctaTarget: "/forfaits?highlight=SCALE",
    pricing: "50$/mois",
    signals,
